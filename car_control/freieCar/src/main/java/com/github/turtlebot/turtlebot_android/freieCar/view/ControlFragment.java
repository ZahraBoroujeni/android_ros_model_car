...
public class ControlFragment extends Fragment {
    ...
    private final View.OnClickListener stopButtonListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (emergency_stop_mode == 1) {
                ...
                freieCarActivity.callPublishStopStart(emergency_stop_mode);
    ...
    private final SeekBar.OnSeekBarChangeListener speedBarListener = new SeekBar.OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            ...
            freieCarActivity.callPublishSpeed(lastProgress);
            if (lastToast == null)
                lastToast = Toast.makeText(freieCarActivity.getBaseContext(), -lastProgress + " deg/s", Toast.LENGTH_SHORT);
            else
    ...
    private final SeekBar.OnSeekBarChangeListener steeringBarListener = new SeekBar.OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            ...
            freieCarActivity.callPublishSteering(angle);
            if (lastToast == null)
                lastToast = Toast.makeText(freieCarActivity.getBaseContext(), lastProgress + " deg", Toast.LENGTH_SHORT);
            else
